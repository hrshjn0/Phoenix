        ...
        <main className="flex-grow">
          ...
          <div className="relative bg-dark">
            ...
            <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
              ...
              <p className="mt-6 text-xl text-white max-w-3xl">Our platform creates value by connecting tech product owners with the right investors. Learn how our process benefits both buyers and sellers.</p>
            </div>
          </div>
