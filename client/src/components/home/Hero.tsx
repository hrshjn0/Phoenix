  ...
  return (
    <div className="relative bg-dark">
      ...
      <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">Your Tech-Enabled Product Deserves Investment. Find an Investor Now.</h1>
