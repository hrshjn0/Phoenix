    ...
    <div className="relative bg-dark">
      ...
      <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4">
          ...
          >
            <Link href={isAuthenticated ? "/buyers" : "/login?role=buyer"}>
              {isAuthenticated ? "Search Products" : "Enter as Investor/Buyer"}
          ...
          >
            <Link href={isAuthenticated ? "/sellers" : "/login?role=seller"}>
              {isAuthenticated ? "Seller Dashboard" : "Enter as Product Owner"}
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
              </svg>
            </Link>
